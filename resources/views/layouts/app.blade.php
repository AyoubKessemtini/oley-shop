                  ...
                  <div class="header_box">
                     <div class="login_menu">
                        ...
                        <li><a href="#">
                           ...
                           @if($auth)
                                 @if($admin)
                                    <li><a href="{{route('adminindex')}}" target="_blank">
                                          <i class="fa fa-bar-chart" aria-hidden="true"></i>
                                          <span class="padding_10">Admin Dashbord</span> </a>
                                    </li>
                                 @endif
                                 @if(!$admin)
                                 ...
                                 <li><a href="#">
                                       ...
                                       <form method="post" action="{{route('logout')}}">
                                          @csrf
                                          <button style="border: none;background-color:transparent;" type="sublit"><i class="fa fa-sign-out" aria-hidden="true"></i><span class="padding_10">LogOut</span></a></button>
                                       </form>
                                 </li>
